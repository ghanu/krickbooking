 ...
 *
 */
class StadiumbookingTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    public function setUp()
    {
        ...
        parent::setUp();
        $this->_stadiumBookingModel = new Application_Model_Stadiumbooking();
        
        //make mock builder to mock booking
        $this->_bookingModel = $this->getMockBuilder('Application_Model_Booking')
     ...
     public function testCreatingBookingWithValidParams()
     {
         ...
         $this->_bookingModel->expects($this->any())->method('createBooking')
             ->willReturn('1');
        
         //act
         $result = $this->_stadiumBookingModel->createBooking($params);
